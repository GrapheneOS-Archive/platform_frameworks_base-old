...
import static android.ext.settings.PsdsServerConstants.GRAPHENEOS_LONGTERM_PSDS_SERVER_1;
import static android.ext.settings.PsdsServerConstants.GRAPHENEOS_LONGTERM_PSDS_SERVER_2;
import static android.ext.settings.PsdsServerConstants.GRAPHENEOS_LONGTERM_PSDS_SERVER_3;
import static android.ext.settings.PsdsServerConstants.GRAPHENEOS_NORMAL_PSDS_SERVER;
import static android.ext.settings.PsdsServerConstants.GRAPHENEOS_REALTIME_PSDS_SERVER;
...
class GnssPsdsDownloader {
    ...
    private static boolean shouldUseGrapheneOsServer(Context context) {
        boolean supportedDevice = Build.DEVICE.equals("cheetah")
                || Build.DEVICE.equals("panther")
                || Build.DEVICE.equals("raven")
                || Build.DEVICE.equals("oriole")
                || Build.DEVICE.equals("bluejay");
        return supportedDevice && ExtSettings.PSDS_SERVER.get(context) == PsdsServerConstants.PSDS_SERVER_GRAPHENEOS_PROXY;
    }
