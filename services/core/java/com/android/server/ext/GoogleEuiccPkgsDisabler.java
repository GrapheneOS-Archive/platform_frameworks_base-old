...
class GoogleEuiccPkgsDisabler extends BroadcastReceiver {
    ...
    private void disablePackages() {
        ...
        for (String pkg : GmsInfo.EUICC_PACKAGES) {
            ...
            if (pm.getApplicationInfo(pkg, 0, USER_ID) == null) {
            ...
            /*
            AOSP T:
            var ces = new PackageManager.ComponentEnabledSetting(pkg, PackageManager.COMPONENT_ENABLED_STATE_DISABLED, 0);
            var cesList = List.of(ces);
             */
            ...
            for (UserInfo user : users) {
                ...
                /*
                AOSP T:
                pm.setEnabledSettings(cesList, user.id, callingPackage);
                 */
            }
        }
    }
