...
public abstract class SystemSetting extends ContentObserver implements Listenable {
    ...
    public int getValue() {
        return Settings.System.getIntForUser(mContext.getContentResolver(), mSettingName, DEFAULT, mUserId);
    }

    public void setValue(int value) {
        Settings.System.putIntForUser(mContext.getContentResolver(), mSettingName, value, mUserId);
    }
    ...
    public void setListening(boolean listening) {
        ...
        if (listening) {
            ...
            mContext.getContentResolver().registerContentObserver(
                    Settings.System.getUriFor(mSettingName), false, this, mUserId);
        } else {
