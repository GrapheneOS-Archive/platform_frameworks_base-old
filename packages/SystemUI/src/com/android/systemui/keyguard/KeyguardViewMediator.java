...
public class KeyguardViewMediator extends SystemUI implements Dumpable {
    ...
    private void doKeyguardLocked(Bundle options) {
        ...
        showLocked(options);
        final int rebootAfterTimeout = Settings.Global.getInt(mContext.getContentResolver(), Settings.Global.SETTINGS_REBOOT_AFTER_TIMEOUT, 0);
        if (rebootAfterTimeout != 0) {
